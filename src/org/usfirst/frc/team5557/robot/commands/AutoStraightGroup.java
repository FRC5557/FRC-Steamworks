...
public class AutoStraightGroup extends CommandGroup{
    public AutoStraightGroup(){
        addSequential(new UltraDriveCommand(1));//Drive towards peg up until certain distance
        addSequential(new WaitCommand(100));//Extra time for gear to get on peg
        addSequential(new AutoLinearDriveCommand(-1));//Reverse out of airship spot
